...
Technikern besteht eine N:M-Beziehung, die durch die Tabelle\item PyInstaller / \texttt{fpm} packaging commands -- after \textbf{lecture
        13}.
...
\begin{enumerate}[leftmargin=1.6em, topsep=2pt]
  ...
  \item \texttt{sudo dpkg -i wartungsmanagement_1.0.0.deb} -- installiere das Frontend.
